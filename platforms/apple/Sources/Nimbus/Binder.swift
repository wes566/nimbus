...
extension Binder {
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<A0, A1>(_ function: @escaping (A0, A1) throws -> Void, as name: String) where A0: Decodable, A1: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<R: Encodable, A0, A1>(_ function: @escaping (A0, A1) throws -> R, as name: String) where A0: Decodable, A1: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<A0, A1, A2>(_ function: @escaping (A0, A1, A2) throws -> Void, as name: String) where A0: Decodable, A1: Decodable, A2: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<R: Encodable, A0, A1, A2>(_ function: @escaping (A0, A1, A2) throws -> R, as name: String) where A0: Decodable, A1: Decodable, A2: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<A0, A1, A2, A3>(_ function: @escaping (A0, A1, A2, A3) throws -> Void, as name: String) where A0: Decodable, A1: Decodable, A2: Decodable, A3: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<R: Encodable, A0, A1, A2, A3>(_ function: @escaping (A0, A1, A2, A3) throws -> R, as name: String) where A0: Decodable, A1: Decodable, A2: Decodable, A3: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<A0, A1, A2, A3, A4>(_ function: @escaping (A0, A1, A2, A3, A4) throws -> Void, as name: String) where A0: Decodable, A1: Decodable, A2: Decodable, A3: Decodable, A4: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<R: Encodable, A0, A1, A2, A3, A4>(_ function: @escaping (A0, A1, A2, A3, A4) throws -> R, as name: String) where A0: Decodable, A1: Decodable, A2: Decodable, A3: Decodable, A4: Decodable {
        let callable = make_callable(function)
        bind(callable, as: name)
    }
    ...
    /**
     Bind the specified function to this connection.
     */
    public func bind<A0, A1, A2, A3, CB0: Encodable, CB1: Encodable>(_ function: @escaping (A0, A1, A2, A3, @escaping (CB0, CB1) -> Void) throws -> Void, as name: String) where A0: Decodable, A1: Decodable, A2: Decodable, A3: Decodable {
        let wrappedFunction = { (arg0: A0, arg1: A1, arg2: A2, arg3: A3, callable: Callable) -> Void in
